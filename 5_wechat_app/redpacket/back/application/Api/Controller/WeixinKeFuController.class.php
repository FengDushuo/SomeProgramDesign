...
class WeixinKeFuController extends Controller {
	...
	private $token = 'UnXu62fku9oQYl2h7ifNL9';
	// 方法静态化
	...
	public function responseMsg() {
		...
		if (! empty ( $postStr ) && is_string ( $postStr )) {
			...
			if (! empty ( $postArr ['MsgType'] ) && $postArr ['MsgType'] == 'text') { // 文本消息
				...
				$content = '您好，有什么能帮助你?';
              $content2 = '包你说微信红包程序搭建，联系QQ：201855699';
               $content3 = 'http://tc.sinaimg.cn/maxwidth.2048/tc.service.weibo.com/mmbiz_qpic_cn/9cc1470f8f6fd8cf8b867014947806c8.jpg';
							 $content4 = 'http://www.010xr.com/';
				$data = array (
						"touser" => $fromUsername,
						"msgtype" => "link",
						"link" => array (
