...
export default class Header extends Component {
  componentDidMount() {
    ...
    const strings  = ['Condensed Matter Physics','First Principle Calculation', 'Machine Learning in Physics', 'High Performance Computing'];
      ...
      <header id="home">
        <nav id="nav-wrap">
          ...
          <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#mission">Welcome</a></li>
